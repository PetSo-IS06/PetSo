...
<head>
    ...
    <title><?php echo SITE_NAME; ?> | Sponsor Animal</title>
</head>
<body>
<div id="top-nav">
            <?php
    ...
    <form action="<?php echo URL_ROOT; ?>/users/sponsor" method="POST" enctype="multipart/form-data">
    <div class="container">
          ...
          <div class="column">
              <div class="card2"> <center>
                ...
                <input type="date" placeholder="DD/MM/YY"  name="start_date" value="<?php echo $data['start_date']; ?>">
                </div>
                <span class="invalidInput"><?php echo $data['start_dateError']; ?></span>

                <div class="inputBx2">
                <label class="normal grey">Sponsor Until</label>
                 <input type="date" placeholder="DD/MM/YY" name="end_date" value="<?php echo $data['end_date']; ?>">
                </div>
                <span class="invalidInput"><?php echo $data['end_dateError']; ?></span>
                <br>
                
                <div class="normal purple">Total Amount(LKR) : 19000</div><br><br>
