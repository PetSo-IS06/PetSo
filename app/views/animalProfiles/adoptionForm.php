...
<div id="top-nav">
    ...
    <div class="row">
        ...
        <div class="column">
            ...
            <input type="text" placeholder="text" id="title" name="fname"><br>
            <label for="lname">Address</label><br>
            <input type="text" placeholder="text" id="lname" name="lname"> <br>
            <label for="lname">Mobile Number</label><br>
            <input type="text" placeholder="text" id="lname" name="lname">
            <label for="lname">Requirements</label><br> <br>
            <input type="checkbox" id="Requirements">  aassdddvnnmm <br><br>
