                    ...
                    <div class="form-row" style="flex-direction: column; justify-content: left">
                        <div class="form-input" id="col" style="flex-direction: row; justify-content: left">
                            <div class="form-input-col">
                                ...
                                <textarea class="input-box" style="width: 410px" name="name" id="name"
                                          type="text"></textarea>
                            </div>
                        </div>
                        <div class="form-input" id="col" style="flex-direction: row; justify-content: left">
                            <div class="form-input-col">
                                ...
                                <textarea class="input-box" style="width: 410px" name="mobile" id="mobile"
                                          type="text"></textarea>
                            </div>
                        </div>
                        <div class="form-input" id="col" style="flex-direction: row; justify-content: left">
                            <div class="form-input-col">
                                ...
                                <textarea class="input-box" style="width: 410px" name="email" id="email"
                                          type="text"></textarea>
                            </div>
                        </div>
...
<!--                            <span class="invalidInput">--><?php //echo $data[1]['animalError']; ?><!--</span>-->
                        </div>
                    </div>
                </div>
                <div class="form-row" style="flex-direction:row; justify-content: space-between;">
